...
module.exports = "<form #materialForm=\"ngForm\" (ngSubmit)=\"onSubmit(materialForm)\">\n  <input type=\"hidden\" name=\"key\" #key=\"ngModel\" [(ngModel)]=\"materialService.selectedMaterial.key\">\n  <div class=\"control-group\">\n    <div class=\"form-group floating-label-form-group controls mb-0 pb-2\">\n      <label>Τίτλος</label>\n      <input class=\"form-control\" name=\"title\" #title=\"ngModel\" [(ngModel)]=\"materialService.selectedMaterial.title\" placeholder=\"Τίτλος\"\n        required>\n    </div>\n  </div>\n  <div class=\"control-group\">\n    <div class=\"form-group floating-label-form-group controls mb-0 pb-2\">\n      <label>1ο Κείμενο</label>\n      <textarea rows=\"4\" class=\"form-control\" name=\"text1\" #text1=\"ngModel\" [(ngModel)]=\"materialService.selectedMaterial.text1\"\n        placeholder=\"1ο Κείμενο\"></textarea>\n    </div>\n  </div>\n  <div class=\"control-group\">\n    <div class=\"form-group floating-label-form-group controls mb-0 pb-2\">\n      <label>2ο Κείμενο</label>\n      <textarea rows=\"4\" class=\"form-control\" name=\"text2\" #text2=\"ngModel\" [(ngModel)]=\"materialService.selectedMaterial.text2\"\n        placeholder=\"2ο Κείμενο\"></textarea>\n    </div>\n  </div>\n  <div class=\"control-group\">\n    <div class=\"form-group floating-label-form-group controls mb-0 pb-2\">\n      <label>3ο Κείμενο</label>\n      <textarea rows=\"4\" class=\"form-control\" name=\"text3\" #text3=\"ngModel\" [(ngModel)]=\"materialService.selectedMaterial.text3\"\n        placeholder=\"3ο Κείμενο\"></textarea>\n    </div>\n  </div>\n  <div class=\"control-group\">\n    <div class=\"form-group floating-label-form-group controls mb-0 pb-2\">\n      <label>4ο Κείμενο</label>\n      <textarea rows=\"4\" class=\"form-control\" name=\"text4\" #text4=\"ngModel\" [(ngModel)]=\"materialService.selectedMaterial.text4\"\n        placeholder=\"4ο Κείμενο\"></textarea>\n    </div>\n  </div>\n  <div class=\"control-group\">\n    <div class=\"form-group floating-label-form-group controls mb-0 pb-2\">\n      <label>5ο Κείμενο</label>\n      <textarea rows=\"4\" class=\"form-control\" name=\"text5\" #text5=\"ngModel\" [(ngModel)]=\"materialService.selectedMaterial.text5\"\n        placeholder=\"5ο Κείμενο\"></textarea>\n    </div>\n  </div>\n  <div class=\"control-group\">\n    <div class=\"form-group floating-label-form-group controls mb-0 pb-2\">\n      <label>URL 1ης Εικόνας</label>\n      <input class=\"form-control\" name=\"image1\" #image1=\"ngModel\" [(ngModel)]=\"materialService.selectedMaterial.image1\" placeholder=\"URL 1ης Εικόνας\">\n    </div>\n  </div>\n  <div class=\"control-group\">\n    <div class=\"form-group floating-label-form-group controls mb-0 pb-2\">\n      <label>URL 2ης Εικόνας</label>\n      <input class=\"form-control\" name=\"image2\" #image2=\"ngModel\" [(ngModel)]=\"materialService.selectedMaterial.image2\" placeholder=\"URL 2ης Εικόνας\">\n    </div>\n  </div>\n  <div class=\"control-group\">\n    <div class=\"form-group floating-label-form-group controls mb-0 pb-2\">\n      <label>URL 3ης Εικόνας</label>\n      <input class=\"form-control\" name=\"image3\" #image3=\"ngModel\" [(ngModel)]=\"materialService.selectedMaterial.image3\" placeholder=\"URL 3ης Εικόνας\">\n    </div>\n  </div>\n  <div class=\"control-group\">\n    <div class=\"form-group floating-label-form-group controls mb-0 pb-2\">\n      <label>URL 4ης Εικόνας</label>\n      <input class=\"form-control\" name=\"image4\" #image4=\"ngModel\" [(ngModel)]=\"materialService.selectedMaterial.image4\" placeholder=\"URL 4ης Εικόνας\">\n    </div>\n  </div>\n  <div class=\"control-group\">\n    <div class=\"form-group floating-label-form-group controls mb-0 pb-2\">\n      <label>URL 5ης Εικόνας</label>\n      <input class=\"form-control\" name=\"image5\" #image5=\"ngModel\" [(ngModel)]=\"materialService.selectedMaterial.image5\" placeholder=\"URL 5ης Εικόνας\">\n    </div>\n  </div>\n  <div class=\"control-group\">\n    <div class=\"form-group floating-label-form-group controls mb-0 pb-2\">\n      <label>Επίπεδο</label>\n      <input type=\"number\" class=\"form-control\" name=\"level\" #level=\"ngModel\" [(ngModel)]=\"materialService.selectedMaterial.level\"\n        placeholder=\"Επίπεδο\" required>\n    </div>\n  </div>\n  <br>\n  <div class=\"form-group\">\n    <button type=\"submit\" class=\"btn btn-primary btn-lg\" [disabled]=\"!materialForm.valid\">\n      <i class=\"fa fa-floppy-o\"></i> Υποβολή</button>\n    <button type=\"button\" class=\"btn btn-danger btn-lg\" *ngIf=\"materialService.selectedMaterial.key!=null\" (click)=\"onDelete(materialForm)\">\n      <i class=\"fa fa-trash\"></i> Διαγραφή</button>\n    <button type=\"button\" class=\"btn btn-dark btn-lg\" (click)=\"resetForm(materialForm)\">\n      <i class=\"fa fa-undo\"></i> Επαναφορά</button>\n  </div>\n</form>"
...
module.exports = "<form #quizForm=\"ngForm\" (ngSubmit)=\"onSubmit(quizForm)\">\n  <input type=\"hidden\" name=\"key\" #key=\"ngModel\" [(ngModel)]=\"quizService.selectedQuiz.key\">\n  <div class=\"control-group\">\n    <div class=\"form-group floating-label-form-group controls mb-0 pb-2\">\n      <label>Ερώτηση</label>\n      <input class=\"form-control\" name=\"question\" #question=\"ngModel\" [(ngModel)]=\"quizService.selectedQuiz.question\" placeholder=\"Ερώτηση\"\n        required>\n    </div>\n  </div>\n  <div class=\"control-group\">\n    <div class=\"form-group floating-label-form-group controls mb-0 pb-2\">\n      <label>Απάντηση 1</label>\n      <input class=\"form-control\" name=\"answer1\" #answer1=\"ngModel\" [(ngModel)]=\"quizService.selectedQuiz.answer1\" placeholder=\"Απάντηση 1\"\n        required>\n    </div>\n  </div>\n  <div class=\"control-group\">\n    <div class=\"form-group floating-label-form-group controls mb-0 pb-2\">\n      <label>Απάντηση 2</label>\n      <input class=\"form-control\" name=\"answer2\" #answer2=\"ngModel\" [(ngModel)]=\"quizService.selectedQuiz.answer2\" placeholder=\"Απάντηση 2\"\n        required>\n    </div>\n  </div>\n  <div class=\"control-group\">\n    <div class=\"form-group floating-label-form-group controls mb-0 pb-2\">\n      <label>Απάντηση 3</label>\n      <input class=\"form-control\" name=\"answer3\" #answer3=\"ngModel\" [(ngModel)]=\"quizService.selectedQuiz.answer3\" placeholder=\"Απάντηση 3\"\n        required>\n    </div>\n  </div>\n  <div class=\"control-group\">\n    <div class=\"form-group floating-label-form-group controls mb-0 pb-2\">\n      <label>Απάντηση 4</label>\n      <input class=\"form-control\" name=\"answer4\" #answer4=\"ngModel\" [(ngModel)]=\"quizService.selectedQuiz.answer4\" placeholder=\"Απάντηση 4\"\n        required>\n    </div>\n  </div>\n  <div class=\"control-group\">\n    <div class=\"form-group floating-label-form-group controls mb-0 pb-2\">\n      <label>Σωστή Απάντηση</label>\n      <input class=\"form-control\" name=\"rightAnswer\" #rightAnswer=\"ngModel\" [(ngModel)]=\"quizService.selectedQuiz.rightAnswer\"\n        placeholder=\"Σωστή Απάντηση\" required>\n    </div>\n  </div>\n  <div class=\"control-group\">\n    <div class=\"form-group floating-label-form-group controls mb-0 pb-2\">\n      <label>ID Επόμενης Ερώτησης</label>\n      <input class=\"form-control\" name=\"nextQuiz\" #nextQuiz=\"ngModel\" [(ngModel)]=\"quizService.selectedQuiz.nextQuiz\" placeholder=\"ID Επόμενης Ερώτησης\"\n        required>\n    </div>\n  </div>\n  <div class=\"control-group\">\n    <div class=\"form-group floating-label-form-group controls mb-0 pb-2\">\n      <label>Πόντοι</label>\n      <input type=\"number\" class=\"form-control\" name=\"points\" #points=\"ngModel\" [(ngModel)]=\"quizService.selectedQuiz.points\" placeholder=\"Πόντοι\"\n        required>\n    </div>\n  </div>\n  <div class=\"control-group\">\n    <div class=\"form-group floating-label-form-group controls mb-0 pb-2\">\n      <label>Επίπεδο</label>\n      <input type=\"number\" class=\"form-control\" name=\"level\" #level=\"ngModel\" [(ngModel)]=\"quizService.selectedQuiz.level\" placeholder=\"Επίπεδο\"\n        required>\n    </div>\n  </div>\n  <br>\n  <div class=\"form-group\">\n    <button type=\"submit\" class=\"btn btn-primary btn-lg\" [disabled]=\"!quizForm.valid\">\n      <i class=\"fa fa-floppy-o\"></i> Υποβολή</button>\n    <button type=\"button\" class=\"btn btn-danger btn-lg\" *ngIf=\"quizService.selectedQuiz.key!=null\" (click)=\"onDelete(quizForm)\">\n      <i class=\"fa fa-trash\"></i> Διαγραφή</button>\n    <button type=\"button\" class=\"btn btn-dark btn-lg\" (click)=\"resetForm(quizForm)\">\n      <i class=\"fa fa-undo\"></i> Επαναφορά</button>\n  </div>\n</form>"
...
var InformationComponent = /** @class */ (function () {
    function InformationComponent() {
        this.infoText1 = "Εγγραφή/Σύνδεση Χρήστη: Για να εισέλθει οποιοσδήποτε στην εφαρμογή πρέπει πρώτα να γραφτεί σε αυτή. Αυτό επιτυγχάνεται με 3 διαφορετικούς τρόπους: α) δημιουργία λογαριασμού βάζοντας το email και ένα κωδικό πρόσβασης, β) σύνδεση μέσω Facebook και γ) σύνδεση με λογαριασμό της Google. Αφού γραφτεί, πρέπει να εισάγει τα στοιχεία του για να έχει πρόσβαση στην εφαρμογή.";
        this.infoText2 = "Εκπαιδευτικό Υλικό: Η πρώτη κατηγορία από τις επιλογές που έχει κάποιος χρήστης είναι η κατηγορία εκπαιδευτικού υλικού ή υλικού για μελέτη. Σε αυτή την ενότητα, υπάρχει εκπαιδευτικό υλικό προς ανάγνωση προκειμένου ο μαθητής να κατανοήσει βασικές έννοιες των μαθηματικών και για να είναι σε θέση να απαντήσει στις ερωτήσεις του Quiz-Game. Πιο αναλυτικά ο μαθητής μαθαίνει, τις μαθηματικές πράξεις και τις ιδιότητες τους (πρόσθεση, αφαίρεση, πολλαπλασιασμό, διαίρεση), προτεραιότητες τελεστών σε μια μαθηματική εξίσωση, την προπαίδεια καθώς και τη μεθοδολογία του πως μπορεί να λύσει εύκολα ένα μαθηματικό πρόβλημα.";
        this.infoText3 = "Ερωτήσεις: Επόμενη κατηγορία είναι με ερωτήσεις. Σε αυτή την κατηγορία ο μαθητής μέσα από τη θεωρία μάθησης του κονστρουκτιβισμού, ελέγχει τις γνώσεις που αποκόμισε από όσα διάβασε στην κατηγορία του υλικού για μελέτη. Μέσα λοιπόν από ένα serious game, υποβάλλονται στον μαθητή απλές ερωτήσεις και προβλήματα που τον κάνουν να σκεφτεί και να χρησιμοποιήσει τις γνώσεις του, καθώς και να αξιολογήσει τον εαυτό του. Επίσης ο μαθητής επιβραβεύεται μετά από κάθε σωστή απάντηση με κάποιους πόντους που διαφέρουν ανάλογα με το επίπεδο δυσκολίας της ερώτησης. Στην περίπτωση λάθους η εφαρμογή παροτρύνει το μαθητή να συμβουλευτεί τη σχετική ενότητα θεωρίας που είναι βασισμένη η ερώτηση, προκειμένου να δει το λάθος του και να το διορθώσει.";
        this.infoText4 = "Επιλογή για τον καθηγητή: Με την επιλογή του πίνακα ελέγχου, ο καθηγητής μπορεί να προσθέσει εκπαιδευτικό υλικό εύκολα μέσα από απλά βήματα, ή να τροποποιήσει το ήδη υπάρχον. Επίσης μπορεί να προσθέσει μια νέα ερώτηση, να διαγράψει μια άλλη ή και να κάνει όποια αλλαγή σχετικά με τη διατύπωση, τις απαντήσεις και τη βαθμολογία.";
    }
